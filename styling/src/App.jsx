...
function App(){
  ...
  return(
    ...
    <>
    <h1 style={{backgroundColor:"green",color:"white"}}>hello</h1>
    <h2 style={{backgroundColor:"yellow",padding:"30px"}}>welcome</h2>
    <h3 style={{backgroundColor:"red"}}>everyone</h3>
    <h4 style={mystyle}>cybrom</h4>
    <h5>Bhopal</h5>
    <hr />
    <div className="container">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus hic voluptatem fuga quia nostrum sit, accusamus sapiente, quisquam iure totam enim deserunt dignissimos, perspiciatis ut culpa odio incidunt tempore voluptatum.
      Voluptas quos impedit neque recusandae quod laboriosam odio ut, officiis quidem deleniti facere laudantium. Dolore repellat ipsum, voluptate nam, eaque deserunt accusamus odio, eligendi ea fugit libero delectus esse officia.
